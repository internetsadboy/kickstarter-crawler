...
module.exports = {
  ...
  pledgesData: function ($) {
    var totalNumBackers, pledgeAmounts, digitRegex, n, i, PLEDGES = [];
    ...
    for (i = 0; i < n; i++) {
      ...
      // Number of backers
      pledge.numBackers = Number($('.num-backers').eq(i).text().match(digitRegex)[0]);
